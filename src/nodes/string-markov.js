...
*/
  ...
  Iframework.NativeNodes['string-markov'] = Iframework.NativeNodes[
    'string'
  ].extend({
    ...
    info: {
      title: 'markov',
      description:
        'makes a markov chain based on seed text, useful for gibberish, a kind of cutup method.',
      author: 'BrianHicks',
    },
    events: {
    ...
    inputs: {
      ...
      punctuation: {
        type: 'boolean',
        description:
          'maintain punctuation, which can make interesting sentences',
        default: true,
      },
      generate: {
        type: 'bang',
