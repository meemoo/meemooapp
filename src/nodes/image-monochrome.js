...
$(function () {
  Iframework.NativeNodes['image-monochrome'] = Iframework.NativeNodes[
    'image'
  ].extend({
    info: {
      title: 'monochrome',
      ...
      description:
        'monochrome by atkinson, bayer, floydsteinberg, or no dither',
    },
    ...
    redraw: function () {
      ...
      if (this._image && this._worker && !this._workerBusy) {
        ...
        var imageData = this._image
          .getContext('2d')
          .getImageData(0, 0, this._image.width, this._image.height);
    ...
    inputs: {
      ...
      type: {
        type: 'string',
        description:
          '"atkinson" is like Mac, "bayer" is like Gameboy, "floydsteinberg" is normal dithering, "none" is black and white with no dithering',
